...
COPY target/speed.war apache-tomcat-9.0.89/webapps
COPY run.sh apache-tomcat-9.0.89/bin
RUN chmod u+x apache-tomcat-9.0.89/bin/run.sh
EXPOSE 8080

ENTRYPOINT ["apache-tomcat-9.0.89/bin/run.sh"]